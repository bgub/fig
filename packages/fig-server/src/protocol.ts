...
// Runtime ops, in order: r=resource gate, p=place a late stylesheet by its
// deterministic precedence/href order, s=fill partial segment,
// c=reveal boundary, x=client-render boundary,
// ac/ax=the Activity-aware variants. The
