...
// One bundle serves both pages: /resource mounts the resource-model app;
// the main page hydrates the payload-consumer document.
const resourceElement = document.getElementById(resourceRootId);
if (resourceElement !== null) {
  mountResourceApp(resourceElement);
} else {
  hydratePayloadDemo();
}

function hydratePayloadDemo(): void {
