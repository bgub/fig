...
import { ensureRouteData, Link } from "@bgub/fig-tanstack-router";
import { createFileRoute } from "@tanstack/solid-router";
import {
  postSummaryResource,
  postSummaryResourceKey,
  remotePostStatusResource,
} from "../data.ts";
...
export const Route = createFileRoute("/data")({
  ...
  loader: async ({ context }) => {
    await Promise.all([
      ensureRouteData(context, postSummaryResource, "1"),
      ensureRouteData(context, remotePostStatusResource, "2"),
    ]);
  },
});
