...
- **Phase 5 (targeted-refresh removal)** — not started; the deletion gate items are now exercised by fig-start's client-dom tests plus demo-start's e2e suite on the resource model.
