...
Metadata candidates created while rendering stay detached. Only commit registers a claim or mutates the canonical element, so a suspended or otherwise discarded render cannot change live document metadata.
